...
%\begin{enumerate}[(a)]
%\item Can a binary algebraic structure have two identities?
%\item Is $f:\Z\to \Z$ defined by $f(n) = 2n$ a homomorphism?
%\item If $\lambda\in \C$ is a root of $f(x)\in\C[x]$, is $\CC{\lambda}$ necessarily a root of $f(x)$?
%\end{enumerate}
%\newpage
